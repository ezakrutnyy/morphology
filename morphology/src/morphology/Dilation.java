...
/**
 * ќпераци€ делатации дл€ черно-белого изображени€. 
 * ¬ыполн€ютс€ следующие действи€ дл€ каждого пиксел€
 * - ќтбор пикселей в окрестности выбранного пиксел€ под €дром, те структиурирование
 * - поиск элемента  с максимальным значением €ркости(luminace) под данным €дром
 *  - установка найденного выше макс значени€ дл€ данного пиксел€ под €дром
 *  - новые значени€ добавл€ютс€ в выходное изображение после дилатации
 * 
 */
public class Dilation extends AbstractOperation{
        ...
        public BufferedImage execute(BufferedImage img) {
                ...
                // Dilate центра изображени€, вблизи границ делаем ниже, отдельно
